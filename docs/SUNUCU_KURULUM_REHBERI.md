...
echo "VITE_API_PROXY_TARGET=http://127.0.0.1:4500" > apps/pos/.env.production
echo "VITE_API_PROXY_TARGET=http://127.0.0.1:4500" > apps/admin/.env.production
echo "VITE_API_PROXY_TARGET=http://127.0.0.1:4500" > apps/reseller/.env.production
...
Sunucunuzda aşağıdaki portlar **zaten kullanılmaktadır**:

| Port | Servis | Durum |
|------|--------|-------|
| 3000-3003 | Mevcut Node.js uygulamaları | ❌ DOLU |
| 5000-5001 | Mevcut Node.js uygulamaları | ❌ DOLU |
| 5008-5009 | Node.js / Python uygulamaları | ❌ DOLU |
| 5432 | PostgreSQL | ✅ NextPOS kullanacak |
| 6379 | Redis | ✅ NextPOS kullanacak |

> ✅ NextPOS API bu sunucuda **port 4500** üzerinde çalışacak şekilde yapılandırılmıştır.
...
Şu an API sunucunuzun `4500` portunda çalışıyor olmalı.
